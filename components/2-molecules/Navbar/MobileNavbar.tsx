...
export function MobileNavbar({ className = "", data, testId }: MobileNavbarProps) {
  ...
  return (
    <div className={`z-10 absolute top-0 left-0 w-full ${className}`}>
      {isMenuOpen ? (
        <OpenedMenu className="flex justify-between w-full px-4 py-12 font-bold text-black bg-white">
        ...
        <ClosedMenu className="flex justify-center w-full px-4 py-2 pl-2">
